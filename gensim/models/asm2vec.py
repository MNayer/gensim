...
try:
    from gensim.models.asm2vec_inner import (  # noqa: F401
        train_batch_sg,
        train_batch_cbow,
        score_sentence_sg,
        score_sentence_cbow,
...
try:
    from gensim.models.asm2vec_corpusfile import train_epoch_sg, train_epoch_cbow, CORPUSFILE_VERSION
except ImportError:
...
class Asm2Vec(utils.SaveLoad):
    ...
    def save(self, *args, **kwargs):
        ...
        """
        super(Asm2Vec, self).save(*args, **kwargs)
    ...
    def _save_specials(self, fname, separately, sep_limit, ignore, pickle_protocol, compress, subname):
        ...
        return super(Asm2Vec, self)._save_specials(
    ...
    def load(cls, *args, rethrow=False, **kwargs):
        ...
        """
        try:
            model = super(Asm2Vec, cls).load(*args, **kwargs)
            if not isinstance(model, Asm2Vec):
                rethrow = True
    ...
    def _load_specials(self, *args, **kwargs):
        ...
        super(Asm2Vec, self)._load_specials(*args, **kwargs)
...
class Asm2VecVocab(utils.SaveLoad):
    """Obsolete class retained for now as load-compatibility state capture."""
    pass


class Asm2VecTrainables(utils.SaveLoad):
    """Obsolete class retained for now as load-compatibility state capture."""
    pass
...
if __name__ == "__main__":
    ...
    from gensim.models.word2vec import Asm2Vec # noqa:F811 avoid referencing __main__ in pickle
